          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("Get Help", style: gethelp.copyWith(fontSize: 12)),
              ],
            ),
          ),
        ],
          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: Container(
                  child: Image.asset("assets/images/logo_NB.png", fit: BoxFit.fill, width: 80),
                ),
              ),
              Form(
                key: _formkey,
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Create your Account", style: PoppinsBold.copyWith(fontSize: 20)),
                    Text("Please enter your details to continue", style: Poppins),
                    SizedBox(height: 5),
                    ...
                    SizedBox(height: 10),
                    Text("Name", style: PoppinsBold.copyWith(fontSize: 12)),
                    TextFormField(
                      controller: namec,
                      decoration: InputDecoration(
                      ...
                      validator: (value) {
                        if (namec.text.length < 3) {
                          showSnackbar(context, "Name should be at least 3 characters");
                        }
                      },
                    ),
                    SizedBox(height: 10),
                    ...
                    SizedBox(height: 10),
                    Text("Confirm password", style: PoppinsBold.copyWith(fontSize: 12)),
                    TextFormField(
                      obscureText: true,
                      obscuringCharacter: "*",
                      decoration: InputDecoration(
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(text: "By signing up, you agree to our ", style: Poppins.copyWith(fontSize: 11)),
                          TextSpan(
                          ...
                          TextSpan(text: " and ", style: Poppins.copyWith(fontSize: 11)),
                          TextSpan(
                            text: "Privacy Policy",
                            style: PoppinsBold.copyWith(
                              decoration: TextDecoration.underline,
