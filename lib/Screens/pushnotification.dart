...
class PushNotifications {
  ...
  static saveTokentoServer({required String token}) async {
    var response = await http.post(
      Uri.parse("http://192.168.1.3:2000/saveToken"),
      headers: <String, String>{
        "Content-Type": "application/json",
      },
      body: jsonEncode(<String, String>{"token": token}), //encode data using jsonEncode
    );
    print(response.body);
  }
  ...
  static void onNotificationTap(NotificationResponse notificationResponse) {
    print('Showing local notifications on tap');
